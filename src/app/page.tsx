  ...
  return (
    <ListingPageTemplate
      hero={{
        ...
        subtitle: 'Investigate. Understand. Respond.',
        description:
          'In-depth research, biblical analysis and real-world context for the issues that challenge Christian faith today.',
      }}
      title="RCA Library"
      subtitle="In-depth analysis of key issues, with biblical responses."
      items={cards}
