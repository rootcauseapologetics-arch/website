  ...
  return (
    <div className="min-h-screen bg-[#071E2D] text-white flex flex-col pb-20 md:pb-12">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
        {/* Breadcrumb Trail */}
        <div className="flex items-center gap-2 text-xs text-[#88CCD9]/70">
              ...
              <div className="space-y-2.5">
                <div className="flex items-center justify-between gap-4 flex-wrap">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      onClick={handleShare}
                      className="px-3.5 py-1.5 bg-[#0A243A] hover:bg-[#0E304C] text-[#88CCD9] hover:text-white text-xs font-semibold rounded-lg border border-[#143B5C] transition-all flex items-center gap-1.5"
                    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="hidden lg:block lg:col-span-4 sticky top-24 space-y-6">
            {/* Table of Contents */}
            {tocItems.length > 0 && (
              <div className="bg-[#0A243A] border border-[#143B5C] rounded-xl p-5 space-y-3">
                  ...
                  {tocItems.map((item) => (
                    <a
                      ...
                      className={`block px-2.5 py-1.5 rounded-md transition-all ${
                        activeToc === item.id
                          ? 'bg-[#082A44] text-[#00B4FF] font-semibold border-l-2 border-[#00B4FF]'
            ...
            {relatedItem && (
              <div className="bg-[#0A243A] border border-[#143B5C] rounded-xl p-5 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/" className="text-[11px] text-[#00B4FF] hover:underline font-semibold">
                    View All &rarr;
                  </Link>
                </div>
                <Link
